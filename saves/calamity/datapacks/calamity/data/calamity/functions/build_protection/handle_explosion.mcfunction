...
#   marker entity @e[current_world=true,tag=marker,tag=arenaHeight].
...
execute store result score #tempHeight gameVariable run data get entity @e[current_world=true,tag=marker,tag=arenaHeight,limit=1,type=minecraft:area_effect_cloud] Pos[1]
