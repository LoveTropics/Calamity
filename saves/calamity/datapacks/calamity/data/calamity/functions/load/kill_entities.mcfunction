...
execute as @e[current_world=true,type=!player] run data modify entity @s Glowing set value 0
execute as @e[current_world=true,type=!player] run teleport @s ~ -50 ~
execute as @e[current_world=true,type=!player] run kill @s
