...
execute as @a[current_world=true,scores={startMatch=1..},team=blue] run tellraw @a[current_world=true] {"translate":"system.message","color":"green","with":[{"translate":"calamity.match.started.byPlayer","color":"blue","with":[{"selector":"@s"},{"translate":"▶"}]}]}
execute as @a[current_world=true,scores={startMatch=1..},team=red] run tellraw @a[current_world=true] {"translate":"system.message","color":"green","with":[{"translate":"calamity.match.started.byPlayer","color":"red","with":[{"selector":"@s"},{"translate":"▶"}]}]}
execute if score #PlayersPlaying gameVariable matches 0 run tellraw @a[current_world=true] {"translate":"system.message","color":"green","with":[{"translate":"calamity.match.cancelled.noPlayers","color":"red","with":[{"translate":"⏹"}]}]}
...
execute if score #PlayersPlaying gameVariable matches 1.. run scoreboard players enable @a[current_world=true] cancelStart
