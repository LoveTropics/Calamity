...
execute if entity @a[current_world=true,scores={arena=1..},limit=1] if score ArenaSelectCooldown gameVariable matches 1.. run tellraw @a[current_world=true] {"translate":"system.message","color": "red","with":[{"translate":"calamity.arena.error.cooldown"}]}
execute if entity @a[current_world=true,scores={arena=1..},limit=1] if score ArenaSelectCooldown gameVariable matches 1.. run scoreboard players reset @a[current_world=true] arena
execute if entity @a[current_world=true,scores={arena=1..},limit=1] if score ArenaSelectCooldown gameVariable matches 1.. run scoreboard players enable @a[current_world=true] arena
...
execute if score @a[current_world=true,scores={arena=1..},limit=1] arena = #currentArena gameVariable run tellraw @a[current_world=true,scores={arena=1..}] {"translate":"system.message","color":"red","with":[{"translate": "calamity.arena.error.sameArena"}]}
execute if score @a[current_world=true,scores={arena=1..},limit=1] arena = #currentArena gameVariable run scoreboard players reset @a[current_world=true] arena
# Pass the variable from the player to our system.
scoreboard players operation #selectedArena gameVariable = @a[current_world=true,scores={arena=1..},limit=1] arena
# We're done with the player now. Always enable triggers.
scoreboard players reset @a[current_world=true] arena
scoreboard players enable @a[current_world=true] arena
...
execute if score #selectedArena gameVariable matches 1.. run tellraw @a[current_world=true] {"translate":"system.message","color":"green","with":[{"translate":"calamity.arena.loading"}]}
...
execute if score #selectedArena gameVariable matches 1.. run function calamity:arena/handler
# Handle players
execute if score #selectedArena gameVariable matches 1.. run execute as @a[current_world=true] run function calamity:player/reset_data
execute if score #selectedArena gameVariable matches 1.. run execute as @a[current_world=true] run function calamity:player/set_to_lobby_mode
