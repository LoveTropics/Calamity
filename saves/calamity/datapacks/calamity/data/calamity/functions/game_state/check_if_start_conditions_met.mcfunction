...
execute unless entity @a[current_world=true,team=blue] run scoreboard players remove #PlayersPlaying gameVariable 1
execute unless entity @a[current_world=true,team=red] run scoreboard players remove #PlayersPlaying gameVariable 1
