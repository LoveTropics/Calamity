...
tellraw @a[current_world=true] {"translate":"system.message","color":"red","with":[{"translate":"calamity.team.notReady.red","color":"green","with":[{"translate":"team.red","color":"red"},{"translate":"r","font": "calamity:icons","color":"red"},{"translate":"☒","color":"dark_red"}]}]}
