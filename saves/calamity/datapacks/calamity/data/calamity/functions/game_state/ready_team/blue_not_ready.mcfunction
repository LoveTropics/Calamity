...
tellraw @a[current_world=true] {"translate":"system.message","color":"blue","with":[{"translate":"calamity.team.notReady.blue","color":"green","with":[{"translate":"team.blue","color":"blue"},{"translate":"b","font": "calamity:icons","color":"blue"},{"translate":"☒","color":"dark_red"}]}]}
